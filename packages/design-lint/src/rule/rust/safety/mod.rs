...
use syn::{
    Attribute, Expr, ExprUnsafe, ImplItemFn, ItemFn, ItemImpl, ItemMod, ItemTrait, Macro, Token,
...
impl Syntax<'_> {
    ...
    fn report(&mut self, span: Span, subject: String, construct: &'static str) {
        ...
        finding.message = format!(
            "{construct} is outside the native execution source tree or an explicit application FFI module"
        );
